...
# 모델 학습
model.fit(train_generator,batch_size=500 ,epochs=10, validation_data=val_generator)

# 학습된 모델 저장
model.save_weights("C:\\Users\\IT\\Desktop\\dacon_image\\train_model\\unet_model.h5")